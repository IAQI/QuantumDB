...
PRESENTERS = {
    ...
    '2kt3Yyl2TGo': ('Joonho Lee', 'MEDIUM', 'no marker; first author of this paper + webcam'),
    'I1_5BcMjsCE': ('Hsin-Yuan Huang', 'MEDIUM', 'no marker; first author inferred'),
    'NJdcuGDeEiM': ('Angelo Lucia', 'MEDIUM', 'no marker; first author inferred'),
    'TDm8GACmEwA': ('Simon Burton', 'MEDIUM', 'no marker; first author inferred'),
    'VLpeTWtZZXs': ('Markus Hasenöhrl', 'MEDIUM', 'two-photo card; first author / ExQM student'),
    'd9o3RiOgvZY': ('Tomotaka Kuwahara', 'MEDIUM', 'opened on live speaker; first author inferred'),
    'gxgCndCLVpQ': ('Vishal Katariya', 'MEDIUM', 'no marker; first author + young webcam'),
    # LOW: unresolved.
