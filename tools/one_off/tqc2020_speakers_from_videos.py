...
PRESENTERS = {
    ...
    'Exponential quantum communication reductions from generalizations of the Boolean Hidden Matching problem': ('João Fernando Doriguello', 'MEDIUM'),
    ...
    'Quantum algorithms for computational geometry problems': ('', 'LOW'),
    ...
    'Spectral Quantum Tomography': ('Jonas Helsen', 'MEDIUM'),
...
VIDEO = {
    ...
    'Quantum algorithms for computational geometry problems': ('sc_rWyCVZRY', 7510),
